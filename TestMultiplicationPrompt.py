...
def main(nQuestions, nDigitsTop, nDigitsBottom):
  ...
  for question in xrange(nQuestions):
    ...
    del speechEng
    raw_input("Press [Enter] to show answer...")
...
if __name__ == "__main__":
  ...
  try:
    ...
    print("Usage: TestMultiplication.py nQuestions nDigitsTop nDigitsBottom")
    exit()
  
  main(nQuestions, nDigitsTop, nDigitsBottom)
  exit()